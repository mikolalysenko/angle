...
{
    return new WindowSurfaceWGL(this->getRenderer(), window, mPixelFormat, mWGLContext, mFunctionsWGL);
}
                                              ...
                                              const egl::AttributeMap &attribs)
{
    ...
    return new PbufferSurfaceWGL(this->getRenderer(), width, height, textureFormat, textureTarget, largest,
